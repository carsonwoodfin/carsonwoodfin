...
co morbidity burden, and selected medication-class burden are associated with
receipt of anti-amyloid therapy (AAT) among patients seen at the
...
This project packager contains:
...
Means bias-reduced logistic regression was used as the primary adjusted model
...
* Distance was not independently assocaited with ATT receipt



Sequential models suggested that adjustment for demographic composition and
distance produced the greatest attentuation of the unadjusted SVI association.
...
project/
----README.md
-------01\_mdc\_stl\_att\_svi\_analysis.R
--------aggregate\_results/
--------analysis\_output\_inventory.csv
--------r\_session\_information.txt
--------figures/
--------att\_receipt\_by\_svi\_desert\_palette.png
--------att\_receipt\_by\_svi\_and\_comorbidity.png
--------att\_receipt\_by\_svi\_and\_medication\_burden.png
--------primary\_adjusted\_forest\_plot.png
-------tables/
-------descriptive\_results\_by\_svi.csv
-------att\_receipt\_by\_svi.csv
-------att\_receipt\_by\_svi\_and\_comorbidity.csv
-------att\_receipt\_by\_svi\_and\_medication.csv
-------primary\_bias\_reduced\_model.csv
...
confirmed the analytic sample and event counts, and checked the reported
